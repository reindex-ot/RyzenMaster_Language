...
### How to Install
To apply your translation, place the generated **.qm** file into the following directory:

`C:\Program Files\AMD\RyzenMaster\bin\Languages`

Once the file is placed, simply launch **Ryzen Master**, and the language will be applied automatically.
...
### インストール方法
作成した **.qm** ファイルを以下のディレクトリに配置してください。

`C:\Program Files\AMD\RyzenMaster\bin\Languages`

配置後、**Ryzen Master** を起動すると、自動的に言語が切り替わった状態で立ち上がります。
